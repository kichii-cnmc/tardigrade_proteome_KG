...
# if none, make data/raw/rv_proteome directory
mkdir -p data/raw/rv_proteome
...
mv data/rv_uniprot.fasta data/raw/rv_proteome/rv_uniprot_proteome.fasta
...
mv data/rv_ncbi/ncbi_dataset/data/GCA_001949185.1/protein.faa data/raw/rv_proteome/rv_ncbi_proteome.faa
...
mv data/he_uniprot.fasta data/raw/he_proteome/he_uniprot_proteome.fasta
...
mv data/he_ncbi/ncbi_dataset/data/GCA_002082055.1/protein.faa data/raw/he_proteome/he_ncbi_proteome.faa
