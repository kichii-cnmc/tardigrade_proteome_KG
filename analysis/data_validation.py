...
if __name__ == "__main__":
    ...
    # genename (2)
    rv_genename_validator = DataValidator('data/3_organized/RV_Gene_Name.tsv', rv_uniprot_id_list, 'RV Gene Name')
    he_genename_validator = DataValidator('data/3_organized/HE_Gene_Name.tsv', he_uniprot_id_list, 'HE Gene Name')
    rv_genename_validator.run_common_checks()
    he_genename_validator.run_common_checks()
    rv_genename_validator.output_report('data/4_analysis/RV_Gene_Name_validation_report.tsv')
    he_genename_validator.output_report('data/4_analysis/HE_Gene_Name_validation_report.tsv')
    # organism_name (2)
    rv_organism_validator = DataValidator('data/3_organized/RV_Organism_Name.tsv', rv_uniprot_id_list, 'RV Organism Name')
    he_organism_validator = DataValidator('data/3_organized/HE_Organism_Name.tsv', he_uniprot_id_list, 'HE Organism Name')
    rv_organism_validator.run_common_checks()
    he_organism_validator.run_common_checks()
    rv_organism_validator.output_report('data/4_analysis/RV_Organism_Name_validation_report.tsv')
    he_organism_validator.output_report('data/4_analysis/HE_Organism_Name_validation_report.tsv')
    # af structures (2)
    ...
    # pfam (2)
    rv_pfam_validator = DataValidator('data/3_organized/RV_Pfam_domains.tsv', rv_uniprot_id_list, 'RV Pfam Domains')
    he_pfam_validator = DataValidator('data/3_organized/HE_Pfam_domains.tsv', he_uniprot_id_list, 'HE Pfam Domains')
    rv_pfam_validator.run_unweighted_assignment_checks()
    he_pfam_validator.run_unweighted_assignment_checks()
    rv_pfam_validator.output_report('data/4_analysis/RV_Pfam_domains_validation_report.tsv')
    he_pfam_validator.output_report('data/4_analysis/HE_Pfam_domains_validation_report.tsv')
    # prosite (2)
    rv_prosite_validator = DataValidator('data/3_organized/RV_PROSITE_annotations.tsv', rv_uniprot_id_list, 'RV PROSITE Annotations')
    he_prosite_validator = DataValidator('data/3_organized/HE_PROSITE_annotations.tsv', he_uniprot_id_list, 'HE PROSITE Annotations')
    rv_prosite_validator.run_unweighted_assignment_checks()
    he_prosite_validator.run_unweighted_assignment_checks()
    rv_prosite_validator.output_report('data/4_analysis/RV_PROSITE_annotations_validation_report.tsv')
    he_prosite_validator.output_report('data/4_analysis/HE_PROSITE_annotations_validation_report.tsv')
    # string ppi (2)
